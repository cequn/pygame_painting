...
class Menu:
  def __init__(self, screen):
    ...
    for (i, rgb) in enumerate(self.colors):
      rect = pygame.Rect(lmargin + i % 2 * 32, tmargin + 270 + i / 2 * 32, 32, 32)
    ...
    for (i, img) in enumerate(self.pens):
        rect = pygame.Rect(lmargin, tmargin + i * (64+2), 64, 64)
    ...
    for (i, img) in enumerate(self.sizes):
      rect = pygame.Rect(lmargin + i * 32, tmargin + 142, 32, 32)
    ...
    self.save_btn_rect = pygame.Rect(718, tmargin, 64, 32)
    self.cancel_btn_rect = pygame.Rect(718, tmargin + 50, 64, 32)
  ...
  def draw(self):
    ...
    self.screen.fill((255, 255, 255), (lmargin, tmargin + 174, 64, 64))
    pygame.draw.rect(self.screen, (0, 0, 0), (lmargin, tmargin + 174, 64, 64), 1)
    ...
    self.screen.blit(self.edit_area,(150,25))
